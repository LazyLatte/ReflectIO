...
import {Vector2D, CellRay, GridRay, Laser, Mirror, Target, SetTargetClear, Object} from '../Interfaces';
...
export const useGridRay = (height: number, width: number, lasers: Laser[], reflectors: Mirror[], lens: Mirror[], targets: Target[], setTargetClear: SetTargetClear) => {
